...
usage() {
  ...
  echo -e "\t\tAPPLICATION: The application to pull from, one of ${APPLICATIONS_OPTIONS[@]} | all\n"
  echo -e "\t\tENVIRONMENT: The environment to pull from, one of ${ENVIRONMENTS_OPTIONS[@]} | all\n"
  echo -e "\tOptions:"
